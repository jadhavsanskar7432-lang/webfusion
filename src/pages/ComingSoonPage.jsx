  ...
  return (
    <div className="container flex flex-col items-center justify-center min-h-[calc(100vh-56px)] text-center py-16">
      <div className="w-20 h-20 rounded-full bg-text-primary/5 flex items-center justify-center mb-6">
        <Construction size={36} className="text-text-secondary/60" />
      </div>
      <h1 className="font-display text-3xl font-medium text-text-primary mb-2">{title}</h1>
      <p className="text-sm text-text-secondary max-w-md mb-2">
        {description || 'This feature is currently under development and will be available soon.'}
      </p>
      <div className="flex items-center gap-1.5 text-xs text-text-secondary/60 mb-8">
        <Clock size={12} />
